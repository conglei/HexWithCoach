...
|----|-------|-------|-----------|------|--------|
| [MC-R0](MC-R0-window-shell-carryforward.md) | Companion window shell (from MC-7) | ✅ | MC-R1 | S | DONE |
...
| [MC-R5](MC-R5-macos-coach-hub.md) | macOS Coach hub — Review feed + activation (was MC-8) | ◐ | MC-R0, MC-R4 | L | DONE |
| [MC-R6](MC-R6-macos-practice-surface.md) | macOS Practice surface (PR-2 on Mac) | ➕ | MC-R2, MC-R5 | M | IN-PROGRESS |
| [MC-R7](MC-R7-macos-progress.md) | macOS Progress — observation projections (was MC-10) | ◐ | MC-R4, MC-R0 | M | IN-PROGRESS |
