...
struct SettingsView: View {
            ...
            Form {
                ...
                Section {
                    Button {
                        ...
                        Label("Set up Voco", systemImage: "checklist")
                    }
                } footer: {
    ...
    private var pronunciationModelFooter: some View {
        ...
        case .downloading:
            Text("You can keep using Voco while this downloads. If it's interrupted, it resumes where it left off.")
        default:
    ...
    private var syncFooter: some View {
        if syncChangedThisLaunch {
            Text("Restart Voco to apply the sync change.")
